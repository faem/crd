...
var custompodsResource = schema.GroupVersionResource{Group: "crd", Version: "v1alpha1", Resource: "custompods"}

var custompodsKind = schema.GroupVersionKind{Group: "crd", Version: "v1alpha1", Kind: "CustomPod"}
